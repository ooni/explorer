...
export const GridBox = ({
  ...
  return (
    <Link href={href}>
      <div className="flex flex-col group p-3 justify-between min-h-[150px] border border-gray-400 hover:border-blue-600 relative text-black ">
        <div className="text-base font-bold group-hover:text-blue-600">
          {title}
        </div>
