describe('Measurement Page Tests', () => {
  ...
  describe('Web Connectivity tests', () => {
    it('renders a valid accessible og:description', () => {
      ...
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
        'OONI data suggests www.theguardian.com was accessible in United States on November 10, 2022 at 10:09:16 AM UTC, find more open data on internet censorship on OONI Explorer.',
      )
    })
    ...
    it('renders a valid blocked og:description', () => {
      ...
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
        'OONI data suggests rutor.org was blocked in Russia on December 15, 2021 at 5:44:55 AM UTC, find more open data on internet censorship on OONI Explorer.',
      )
    })
    ...
    it('renders a valid anomaly og:description', () => {
      ...
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
        'OONI data suggests www.google.com was accessible in Malaysia on November 10, 2022 at 10:25:51 AM UTC, find more open data on internet censorship on OONI Explorer.',
      )
    })
    ...
    it('shows that the website measurement was for a down site', () => {
      ...
      cy.heroHasColor(errorColor).contains('Website Down')
    })

    it('renders a failed measurement', () => {
      cy.visit('/m/012019111898e81f78c44cf8689fa32f5d1cb664')
      cy.heroHasColor(errorColor).contains('Error')
    })
  ...
  describe('Facebook Messenger Tests', () => {
    ...
    it('renders a reachable og:description', () => {
      ...
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
        'OONI data suggests Facebook Messenger was reachable in United States on November 10, 2022 at 10:42:52 AM UTC, find more open data on internet censorship on OONI Explorer.',
      )
    })
    ...
    it('renders a unreachable og:description', () => {
      ...
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
        'OONI data suggests Facebook Messenger was NOT reachable in Russia on November 10, 2022 at 10:32:58 AM UTC, find more open data on internet censorship on OONI Explorer.',
      )
    })
  })
  ...
  describe('HTTP Header Field Manipulation Tests', () => {
    it('renders a valid measurement', () => {
      ...
      cy.heroHasColor(normalColor).contains('No middleboxes detected')
    })
    it('render an anomaly measurement', () => {
      cy.visit('/m/0120190530049ab375070fa2186452757fa15d2d')
      cy.heroHasColor(anomalyColor).contains('Network tampering')
    })
    it('renders a valid og:description', () => {
      cy.visit(
        '/m/20221110105736.694076_ES_httpheaderfieldmanipulation_ea459e693b3d42a2',
      )
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
    ...
    it('renders an anomaly og:description', () => {
      cy.visit(
        '/m/20221110104928.397322_IR_httpheaderfieldmanipulation_33ed804ee27d4955',
      )
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
  ...
  describe('HTTP Invalid Request Line Tests', () => {
    ...
    it('renders a valid og:description', () => {
      cy.visit(
        '/m/20221110105942.212061_TR_httpinvalidrequestline_f99ce62beb3badb9',
      )
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
    ...
    it('render an anomaly og:description', () => {
      cy.visit(
        '/m/20221110105947.714767_US_httpinvalidrequestline_48ce6c10181803ab',
      )
      cy.get('head meta[property="og:description"]').should(
        'have.attr',
        'content',
  ...
  describe('NDT Tests', () => {
    it('renders a valid measurement', () => {
      ...
      cy.heroHasColor(ooniBlue).contains('Results')
    })

    it('renders a failed measurement', () => {
      cy.visit('/m/01201911098a2eebcc7e2987c051a332b7769a57')
      cy.heroHasColor(ooniBlue).contains('Failed')
    })
  ...
  describe('Psiphon Tests', () => {
    it('renders an accessible measurement', () => {
      ...
      cy.heroHasColor(normalColor).contains('Psiphon works')
    })
    it('renders an anomaly measurement', () => {
      cy.visit('/m/20201203083035.979967_HK_psiphon_6cdafc0b20693ffb')
      cy.heroHasColor(anomalyColor).contains('Psiphon is likely blocked')
    })
    it('renders a reachable og:description', () => {
  ...
  describe('Tor Tests', () => {
    it('renders an accessible measurement', () => {
      ...
      cy.heroHasColor(normalColor).contains('Tor works')
    })
    it('renders an anomaly measurement', () => {
      cy.visit('/m/20201203023552.701125_CN_tor_5968b910a2f8e92c')
      cy.heroHasColor(anomalyColor).contains('Tor is likely blocked')
    })
    it('renders a valid og:description', () => {
  ...
  describe('Invalid Measurements', () => {
    it('URL with invalid measurement_uid says measurement was not found', () => {
      ...
      cy.get('h4')
        .contains('Measurement not found')
        .siblings('div')
        .contains(reportIdNotInDB)
    })
